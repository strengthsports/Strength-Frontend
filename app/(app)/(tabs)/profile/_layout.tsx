          ...
          >
            ...
            >
              ...
              >
                ...
                <View style={{ marginTop: 5, marginRight: 5, height: "auto" }}>
                  {user?.address?.country && user?.type !== "Page" && (
                    <View
                      style={{
                        flexDirection: "row",
                        gap: 4,
                    ...
                    >
                      ...
                      >
                        {getShortCountryName(user?.address?.country, 6)}
                      </TextScallingFalse>
                    </View>
                  )}
                </View>
                    ...
                    {user?.websiteLink && (
                      ...
                      >
                        ...
                        >
                          <TextScallingFalse
                            style={{
                              color: isLinkTextPressed ? "#12956B" : "#E1E1E1",
