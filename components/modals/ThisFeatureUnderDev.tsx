...
const ThisFeatureUnderDev = ({ isVisible, onClose }: ThisFeatureUnderDevProps) => {
    ...
    return (
        <View style={{
            ...
            <View style={{gap: 20, justifyContent:'center', alignItems:'center', padding: 30}}>
            <TextScallingFalse style={{ color: 'white', fontSize: 15, fontWeight: '400', textAlign:'center'}}>This is Feature is under development</TextScallingFalse>
